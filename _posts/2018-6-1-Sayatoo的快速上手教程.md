...
## 软件获取
* 1.5.3版：百度即有，或者![Cq3yse.png](https://s1.ax1x.com/2018/06/10/Cq3yse.png)

* 2.1.6版：![CqJC5R.png](https://s1.ax1x.com/2018/06/10/CqJC5R.png)
*__注意：2.1.6版在win10下运行会出现下拉菜单无内容的BUG__*

* 2.2.2版：请联系QQ：1970238666 （需付费）。
...
## 开录
*2.2.2版可以直接导入酷狗krc、QQ qrc、小灰熊ksc，可以省去录歌词的时间。如果是直接导入的可跳过该部分。

导入好歌曲和歌词后，就可以开始录歌词了。

1.5.3在这里：![CIhRQH.jpg](https://s1.ax1x.com/2018/06/01/CIhRQH.jpg)

2.1.6、2.2.2在这里：![CIhcWD.jpg](https://s1.ax1x.com/2018/06/01/CIhcWD.jpg)
...
* 屏幕（2.1.6、2.2.2）：设置项目的分辨率。（会影响到导出虚拟avi时avi的尺寸）
...
1.5.3和2.1.6保存后的项目可以直接导入到会声会影、Pr里，2.2.2保存后的项目也可以直接导入到Vegas、EDIUS（要求6.55以上）。此外可以生成一个虚拟avi文件，使项目文件能够导入到其他不能直接导入项目文件的剪辑软件里。
...
*如果字幕文件无法导入，请尝试卸载虚拟avi解码器，然后重装。旧版解码器不能向上兼容新版字幕文件（绝对的）。*
